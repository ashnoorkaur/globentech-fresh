            ...
            >
              <Text
                style={[
                  styles.choiceTitle,
                  {
                    color: priority === "standard" ? "#fff" : theme.colors.text,
                  },
                ]}
              >
                Standard
              ...
              <Text
                style={[
                  ...
                  {
                    color:
                      priority === "standard" ? "#fff" : theme.colors.textMuted,
                  },
                ]}
              >
                Regular Queue
            ...
            >
              <Text
                style={[
                  styles.choiceTitle,
                  {
                    color: priority === "priority" ? "#fff" : theme.colors.text,
                  },
                ]}
              >
                Priority
              ...
              <Text
                style={[
                  ...
                  {
                    color:
                      priority === "priority" ? "#fff" : theme.colors.textMuted,
                  },
                ]}
              >
                Night Shift
          ...
          <View style={styles.choiceRow}>
            ...
            >
              <Text
                style={[
                  styles.choiceTitle,
                  { color: sampleType === "ore" ? "#fff" : theme.colors.text },
                ]}
              >
                Ore
              </Text>
              <Text
                style={[
                  ...
                  {
                    color:
                      sampleType === "ore" ? "#fff" : theme.colors.textMuted,
                  },
                ]}
              >
                30 min prep time
            ...
            >
              <Text
                style={[
                  styles.choiceTitle,
                  {
                    color: sampleType === "liquid" ? "#fff" : theme.colors.text,
                  },
                ]}
              >
                Liquid
              ...
              <Text
                style={[
                  ...
                  {
                    color:
                      sampleType === "liquid" ? "#fff" : theme.colors.textMuted,
                  },
                ]}
              >
                No prep needed
                ...
                {(["g", "kg", "mL", "L"] as const).map((value) => (
                  ...
                  >
                    <Text
                      style={[
                        styles.unitText,
                        { color: unit === value ? "#fff" : theme.colors.text },
                      ]}
                    >
                      {value}
                    </Text>
