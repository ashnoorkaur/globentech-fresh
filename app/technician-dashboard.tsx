...
const initialMessages: ChatMessage[] = [
  {
    id: "tech-welcome",
    sender: "assistant",
    text: "Technician assistant ready. Ask about assigned tasks, equipment status, samples, or schedule updates.",
  },
];
...
const buildReply = (input: string) => {
  ...
  if (text.includes("task") || text.includes("assigned")) {
    return "Use Assigned Tasks to track workload priorities and due dates for active requests.";
  }

  if (text.includes("equipment") || text.includes("status")) {
    return "Equipment Status helps you capture maintenance progress and testing readiness.";
  }

  if (text.includes("sample")) {
    return "Manage Samples for collection notes, custody status, and quality checkpoints.";
  }

  if (text.includes("schedule") || text.includes("calendar")) {
    return "You can manage timeline updates from your task workflow and calendar integrations.";
  }

  return "I can help with assigned tasks, equipment updates, sample handling, and work navigation.";
};
...
export default function TechnicianDashboard() {
  ...
  const actions = useMemo<TechAction[]>(
    () => [
      {
        title: "Assigned Tasks",
        description: "Track priority jobs and due timelines",
        meta: "0 Open",
        button: "View Tasks",
      ...
      },
      {
        ...
        description: "Report repair and maintenance progress",
        meta: "Update Status",
      ...
      },
      {
        ...
        description: "Capture sample logs and quality checks",
        meta: "Samples",
        button: "Open Samples",
        icon: "flask-outline",
        onPress: () => undefined,
      ...
      {
        title: "Work Calendar",
        description: "Review scheduled tasks and deadlines",
        meta: "Calendar",
          ...
          >
            ...
            <View style={styles.chatComposer}>
              <TextInput
                ...
                placeholder="Ask about tasks, equipment, or samples..."
